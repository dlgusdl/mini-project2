...
insert into comp_tb (email, password, comp_name, representative_name, business_number, photo,  homepage, created_at)
values ('LG@nate.com', 'ea32961dbd579ef5697c367f9267921ee07f14d77fb2d4fb9500d4221d615695', 'LG', '구광모', '987-65-43210', '/images/LG.png', 'www.LG.com',now());
insert into comp_tb (email, password, comp_name, representative_name, business_number, photo,  homepage, created_at)
values ('Naver@nate.com', 'ea32961dbd579ef5697c367f9267921ee07f14d77fb2d4fb9500d4221d615695', '네이버', '변대규', '135-79-00088', '/images/Naver.png', 'www.Naver.com',now());
insert into comp_tb (email, password, comp_name, representative_name, business_number, photo,  homepage, created_at)
...
insert into required_skill_tb ( jobs_id, skill) values (7, 'Spring');
...
values (1, '끊임없이 개선하려는 개발자', '백엔드 이력서의 내용입니다.', '고졸', '신입', '블로그 주소', 1, now());
